...
public class MasterController {
	...
	public ResponseEntity<List<ClassDetails>> getClassDetailList() {

		List<ClassDetails> classDetailList = masterService.getClassDetailList();
		return ResponseEntity.ok(classDetailList);
	}
